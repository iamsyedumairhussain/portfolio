...
const workStepData = [
  {
    id: 1,
    title: "Initial Consultation & Project Scope",
    description: 'I align with your goals and deliver a clear plan with features, timeline, and architecture.',
    svgPath:
  ...
  },
  {
    ...
    description:
      "I build the solution with clean, scalable code and seamless integrations.",
    svgPath:
  ...
  },
  {
    ...
    description:
      "Together, we review the work, test features, and refine the final product..",
    svgPath:
  ...
  },
  {
    ...
    description:
      "I deploy the system, ensure smooth operation, and provide ongoing support if needed.",
    svgPath:
    ...
    >
      ...
      <section className="text-gray-600 body-font">
        ...
        <div className="flex flex-wrap w-full">
          <p className="section-title max-xl:text-center mb-5">Work Process</p>
          ...
          <div className="md:pr-10 md:py-6">
            <div className="flex relative pb-12">
              ...
              <div className="bg-[#A53DFF] flex-shrink-0 w-10 h-10 rounded-full  inline-flex items-center justify-center text-white relative z-10">
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                  <path d="M11 19a8 8 0 1 1 5.293-14.293A8 8 0 0 1 11 19zm10 2-4.35-4.35"></path>
                </svg>
              </div>
              <div className="flex-grow pl-4">
                <h2 className="font-medium font-semibold title-font text-md text-gray-900 mb-1 ">Discovery & Requirements Analysis</h2>
                <ul className="space-y-1 text-left text-body">
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span>Understand business goals & project vision</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Gather technical requirements</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Define scope, features, and timeline</span>
                  </li>
                </ul>
              </div>
            </div>
            <div className="flex relative pb-12">
              ...
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#A53DFF] inline-flex items-center justify-center text-white relative z-10">
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <div className="flex-grow pl-4">
                <h2 className="font-medium font-semibold title-font text-md text-gray-900 mb-1 ">Planning & Architecture</h2>
                <ul className="space-y-1 text-left text-body">
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Design scalable system architecture</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Plan database structure & workflows</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Select optimal tech stack</span>
                  </li>
                </ul>          </div>
            </div>
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                <h2 className="font-medium font-semibold title-font text-md text-gray-900 mb-1 ">UI/UX Strategy</h2>
                <ul className="space-y-1 text-left text-body">
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Define user flows & interactions</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Ensure clean, intuitive user experience</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Align design with brand goals</span>
                  </li>
                </ul>
              </div>
            </div>
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                <h2 className="font-medium font-semibold title-font text-md text-gray-900 mb-1 ">Development</h2>
                <ul className="space-y-1 text-left text-body">
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Build frontend & backend (MERN/MEAN)</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Integrate APIs & third-party services</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Write clean, modular, testable code</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                <h2 className="font-medium font-semibold title-font text-md text-gray-900 mb-1 ">Testing & Quality Assurance</h2>
                <ul className="space-y-1 text-left text-body">
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                  ...
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Bug fixing & optimization</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Cross-browser & device checks</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                <h2 className="font-medium font-semibold title-font text-md text-gray-900 mb-1 ">Deployment & DevOps</h2>
                <ul className="space-y-1 text-left text-body">
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
            ...
            <div className="flex relative pb-12">
              ...
              <div className="flex-grow pl-4">
                <h2 className="font-medium font-semibold title-font text-md text-gray-900 mb-1 ">Documentation & Support</h2>
                <ul className="space-y-1 text-left text-body">
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                  ...
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Smooth handover</span>
                  </li>
                  <li className="flex items-center space-x-3 rtl:space-x-reverse">
                    <svg className="w-4 h-4 text-fg-success shrink-0 me-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                    <span>Post-launch support & enhancements</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div className="grid xs:grid-cols-2 justify-end my-2 w-fit mx-auto ">
        {workStepData.map((data, index) => {
          return (
            <WorkSteps
              data={data}
              style={`max-xs:mt-3 p-4 sm:p-8 bg-white aspect-auto sm:max-w-78 ${index % 2 == 1 ? "xs:ms-3 xs:mt-6 " : "xs:mb-6"
                }`}
              key={index}
            />
          );
